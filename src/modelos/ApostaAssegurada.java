...
/**
 * Representa um aposta assegurada que terá o nome de quem apostou, a quantia
 * apostada, a previsão do cenário onde a aposta está sendo feita, e um valor ou
 * uma taxa referentes ao valor assegurado
 * 
 * @author Douglas Lima
 *
 */
public class ApostaAssegurada extends Aposta {
	...
	/**
	 * Método que atribui à variável tipoSeguro um objeto do tipo Valor, a partir do
	 * paramêtro valor.
	 * 
	 * @param valor
	 *            int que é o valor a ser assegurado.
	...
	/**
	 * Método que atribui à variável tipoSeguro um objeto do tipo Taxa, a partir do
	 * paramêtro Taxa
	 * 
	 * @param taxa
	 *            double que é a taxa a ser aplicada no valor apostado para resultar
	 ...
	 * para reais) - (previsão da aposta) - A representação textual do tipo da
	 * variável tipoSeguro.
	 * 
